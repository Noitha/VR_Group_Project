Shader "Universal Render Pipeline/Open World Nature/Grass"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VertexDescription PopulateVertexData(VertexDescriptionInputs IN)
            {
                ...
                float _Property_C420C64_Out_0 = _UVMASK_ON;
                float _Property_A7CB8F7F_Out_0 = _BAKEDMASK_ON;
                float _Property_C625874B_Out_0 = _VERTEXPOSITIONMASK_ON;
                Bindings_GetHeightMask_60ae5a3adf0ed5040ad3d47f11f13d66 _GetHeightMask_F196DD8;
                _GetHeightMask_F196DD8.ObjectSpacePosition = IN.ObjectSpacePosition;
                _GetHeightMask_F196DD8.VertexColor = IN.VertexColor;
                _GetHeightMask_F196DD8.uv0 = IN.uv0;
                float _GetHeightMask_F196DD8_Mask_1;
                SG_GetHeightMask_60ae5a3adf0ed5040ad3d47f11f13d66(_Property_C420C64_Out_0, _Property_A7CB8F7F_Out_0, _Property_C625874B_Out_0, _GetHeightMask_F196DD8, _GetHeightMask_F196DD8_Mask_1);
                float _Property_9B9D69B9_Out_0 = _BAKEDMASK_ON;
                float _Split_B3784FF9_R_1 = IN.VertexColor[0];
                float _Split_B3784FF9_G_2 = IN.VertexColor[1];
                float _Split_B3784FF9_B_3 = IN.VertexColor[2];
                float _Split_B3784FF9_A_4 = IN.VertexColor[3];
                float _OneMinus_87CF745E_Out_1;
                Unity_OneMinus_float(_Split_B3784FF9_G_2, _OneMinus_87CF745E_Out_1);
                float _Multiply_988C34E6_Out_2;
                Unity_Multiply_float(_OneMinus_87CF745E_Out_1, 0.05, _Multiply_988C34E6_Out_2);
                float _Property_9D41C228_Out_0 = _UVMASK_ON;
                float4 _UV_A404C549_Out_0 = IN.uv0;
                float _Split_3E057A7D_R_1 = _UV_A404C549_Out_0[0];
                float _Split_3E057A7D_G_2 = _UV_A404C549_Out_0[1];
                float _Split_3E057A7D_B_3 = _UV_A404C549_Out_0[2];
                float _Split_3E057A7D_A_4 = _UV_A404C549_Out_0[3];
                float _Multiply_29CBC88A_Out_2;
                Unity_Multiply_float(_Split_3E057A7D_G_2, 0.1, _Multiply_29CBC88A_Out_2);
                float _Branch_2B35CA49_Out_3;
                Unity_Branch_float(_Property_9D41C228_Out_0, _Multiply_29CBC88A_Out_2, 0, _Branch_2B35CA49_Out_3);
                float _Split_EDB5F22E_R_1 = IN.WorldSpacePosition[0];
                float _Split_EDB5F22E_G_2 = IN.WorldSpacePosition[1];
                float _Split_EDB5F22E_B_3 = IN.WorldSpacePosition[2];
                float _Split_EDB5F22E_A_4 = 0;
                float _Add_AE8472CD_Out_2;
                Unity_Add_float(_Split_EDB5F22E_R_1, _Split_EDB5F22E_B_3, _Add_AE8472CD_Out_2);
                float _Multiply_19FEEE03_Out_2;
                Unity_Multiply_float(_Add_AE8472CD_Out_2, 0.02, _Multiply_19FEEE03_Out_2);
                float _Fraction_A6B54190_Out_1;
                Unity_Fraction_float(_Multiply_19FEEE03_Out_2, _Fraction_A6B54190_Out_1);
                float _Add_37EF0CBA_Out_2;
                Unity_Add_float(_Branch_2B35CA49_Out_3, _Fraction_A6B54190_Out_1, _Add_37EF0CBA_Out_2);
                float _Branch_582B8D99_Out_3;
                Unity_Branch_float(_Property_9B9D69B9_Out_0, _Multiply_988C34E6_Out_2, _Add_37EF0CBA_Out_2, _Branch_582B8D99_Out_3);
                ...
                SG_GetWindStrength_e01e2c42537f3fa47bc76ed6e6291364(_GetPivotInWorldSpace_73F19E42_PivotInWS_0, _GlobalWindParameters_B547F135_GustDirection_0, IN.TimeParameters.x, _GlobalWindParameters_B547F135_GustSpeed_1, TEXTURE2D_ARGS(_GustNoise, sampler_GustNoise), _GlobalWindParameters_B547F135_ShiverSpeed_3, TEXTURE2D_ARGS(_ShiverNoise, sampler_ShiverNoise), _Property_267CF497_Out_0, 1, _GetHeightMask_F196DD8_Mask_1, _GlobalWindParameters_B547F135_GustStrength_2, 0.2, _GlobalWindParameters_B547F135_ShiverStrength_4, _Branch_582B8D99_Out_3, _GetWindStrength_5806EF0A, _GetWindStrength_5806EF0A_GustStrength_0, _GetWindStrength_5806EF0A_ShiverStrength_1, _GetWindStrength_5806EF0A_ShiverDirection_2);
            ...
            SurfaceDescription PopulateSurfaceData(SurfaceDescriptionInputs IN)
            {
                ...
                float _Property_FE297004_Out_0 = UNITY_ACCESS_INSTANCED_PROP(ColorCorrection, _Hue);
                float3 _Hue_362C8A32_Out_2;
                Unity_Hue_Normalized_float((_SampleTexture2D_F86B9939_RGBA_0.xyz), _Property_FE297004_Out_0, _Hue_362C8A32_Out_2);
                float _Property_4CFF93A2_Out_0 = UNITY_ACCESS_INSTANCED_PROP(ColorCorrection, _Saturation);
                float _Add_34512591_Out_2;
                Unity_Add_float(_Property_4CFF93A2_Out_0, 1, _Add_34512591_Out_2);
                float3 _Saturation_72BBB88B_Out_2;
                Unity_Saturation_float(_Hue_362C8A32_Out_2, _Add_34512591_Out_2, _Saturation_72BBB88B_Out_2);
                float _Property_501113A3_Out_0 = UNITY_ACCESS_INSTANCED_PROP(ColorCorrection, _Lightness);
                float3 _Add_B6F41520_Out_2;
                Unity_Add_float3(_Saturation_72BBB88B_Out_2, (_Property_501113A3_Out_0.xxx), _Add_B6F41520_Out_2);
                ...
                float4 _SampleTexture2D_F369DF5C_RGBA_0 = SAMPLE_TEXTURE2D(_MaskMap, sampler_MaskMap, IN.uv0.xy);
                float _SampleTexture2D_F369DF5C_R_4 = _SampleTexture2D_F369DF5C_RGBA_0.r;
                float _SampleTexture2D_F369DF5C_G_5 = _SampleTexture2D_F369DF5C_RGBA_0.g;
                float _SampleTexture2D_F369DF5C_B_6 = _SampleTexture2D_F369DF5C_RGBA_0.b;
                float _SampleTexture2D_F369DF5C_A_7 = _SampleTexture2D_F369DF5C_RGBA_0.a;
                float _Property_4CB428E3_Out_0 = _AlphaClipThreshold;
                surface.Albedo = _Add_B6F41520_Out_2;
                surface.Normal = (_SampleTexture2D_12F932C1_RGBA_0.xyz);
                surface.Emission = IsGammaSpace() ? float3(0, 0, 0) : SRGBToLinear(float3(0, 0, 0));
                surface.Metallic = _SampleTexture2D_F369DF5C_R_4;
                surface.Smoothness = _SampleTexture2D_F369DF5C_A_7;
                surface.Occlusion = _SampleTexture2D_F369DF5C_G_5;
