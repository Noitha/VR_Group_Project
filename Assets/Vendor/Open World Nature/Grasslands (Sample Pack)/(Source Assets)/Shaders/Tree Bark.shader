Shader "Universal Render Pipeline/Open World Nature/Tree Bark"
{
    Properties
    {
...
[NoScaleOffset] _ShiverNoise("ShiverNoise", 2D) = "grey" {}
[NoScaleOffset] _GustNoise("GustNoise", 2D) = "grey" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VertexDescription PopulateVertexData(VertexDescriptionInputs IN)
            {
                ...
                float3 _Subtract_8C2882_Out_2;
                Unity_Subtract_float3(IN.WorldSpacePosition, _GetPivotInWorldSpace_73F19E42_PivotInWS_0, _Subtract_8C2882_Out_2);
                float _Split_5C59D412_R_1 = _Subtract_8C2882_Out_2[0];
                float _Split_5C59D412_G_2 = _Subtract_8C2882_Out_2[1];
                float _Split_5C59D412_B_3 = _Subtract_8C2882_Out_2[2];
                float _Split_5C59D412_A_4 = 0;
                float _Add_29305048_Out_2;
                Unity_Add_float(_Split_5C59D412_R_1, _Split_5C59D412_G_2, _Add_29305048_Out_2);
                float _Add_8A213992_Out_2;
                Unity_Add_float(_Add_29305048_Out_2, _Split_5C59D412_B_3, _Add_8A213992_Out_2);
                float _Fraction_F347220A_Out_1;
                Unity_Fraction_float(_Add_8A213992_Out_2, _Fraction_F347220A_Out_1);
                float _Multiply_8DDA1EAB_Out_2;
                Unity_Multiply_float(_Fraction_F347220A_Out_1, 0.15, _Multiply_8DDA1EAB_Out_2);
                float _Split_9AF585BB_R_1 = IN.VertexColor[0];
                float _Split_9AF585BB_G_2 = IN.VertexColor[1];
                float _Split_9AF585BB_B_3 = IN.VertexColor[2];
                float _Split_9AF585BB_A_4 = IN.VertexColor[3];
                float _Add_C2D09B31_Out_2;
                Unity_Add_float(_Split_9AF585BB_G_2, 0.5, _Add_C2D09B31_Out_2);
                float _Multiply_5CAE29F6_Out_2;
                Unity_Multiply_float(_Multiply_8DDA1EAB_Out_2, _Add_C2D09B31_Out_2, _Multiply_5CAE29F6_Out_2);
                float _Multiply_6F67A68B_Out_2;
                Unity_Multiply_float(_Split_9AF585BB_R_1, 0.3, _Multiply_6F67A68B_Out_2);
                float _Add_93C8E2CD_Out_2;
                Unity_Add_float(_Multiply_5CAE29F6_Out_2, _Multiply_6F67A68B_Out_2, _Add_93C8E2CD_Out_2);
                float _Multiply_3D0774BF_Out_2;
                Unity_Multiply_float(_Split_9AF585BB_G_2, 0.5, _Multiply_3D0774BF_Out_2);
                float _Add_E565C427_Out_2;
                Unity_Add_float(_Add_93C8E2CD_Out_2, _Multiply_3D0774BF_Out_2, _Add_E565C427_Out_2);
                float _Add_54442B17_Out_2;
                Unity_Add_float(_Add_E565C427_Out_2, IN.TimeParameters.x, _Add_54442B17_Out_2);
                ...
                SG_GetWindStrength_e01e2c42537f3fa47bc76ed6e6291364(_GetPivotInWorldSpace_73F19E42_PivotInWS_0, _GlobalWindParameters_B547F135_GustDirection_0, _Add_54442B17_Out_2, _GlobalWindParameters_B547F135_GustSpeed_1, TEXTURE2D_ARGS(_GustNoise, sampler_GustNoise), _GlobalWindParameters_B547F135_ShiverSpeed_3, TEXTURE2D_ARGS(_ShiverNoise, sampler_ShiverNoise), _Property_267CF497_Out_0, 1, _Multiply_F7BD1E76_Out_2, _GlobalWindParameters_B547F135_GustStrength_2, 0.2, _GlobalWindParameters_B547F135_ShiverStrength_4, 0, _GetWindStrength_5806EF0A, _GetWindStrength_5806EF0A_GustStrength_0, _GetWindStrength_5806EF0A_ShiverStrength_1, _GetWindStrength_5806EF0A_ShiverDirection_2);
            ...
            SurfaceDescription PopulateSurfaceData(SurfaceDescriptionInputs IN)
            {
                ...
                float _Property_A4D09482_Out_0 = _Hue;
                float3 _Hue_BD55FC05_Out_2;
                Unity_Hue_Normalized_float((_SampleTexture2D_F86B9939_RGBA_0.xyz), _Property_A4D09482_Out_0, _Hue_BD55FC05_Out_2);
                float _Property_B6C1233E_Out_0 = _Saturation;
                float _Add_25A737_Out_2;
                Unity_Add_float(_Property_B6C1233E_Out_0, 1, _Add_25A737_Out_2);
                float3 _Saturation_6CAE1EAC_Out_2;
                Unity_Saturation_float(_Hue_BD55FC05_Out_2, _Add_25A737_Out_2, _Saturation_6CAE1EAC_Out_2);
                float _Property_8F25F68B_Out_0 = _Lightness;
                float3 _Add_F26911D2_Out_2;
                Unity_Add_float3(_Saturation_6CAE1EAC_Out_2, (_Property_8F25F68B_Out_0.xxx), _Add_F26911D2_Out_2);
                ...
                surface.Albedo = _Add_F26911D2_Out_2;
